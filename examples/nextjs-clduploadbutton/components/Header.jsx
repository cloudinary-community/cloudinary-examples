    ...
    <header className="mb-12 mt-0 w-full bg-blue-950 py-4 text-center text-white">
      <div className="mx-auto flex max-w-screen-lg flex-col items-center justify-between gap-2 px-4 sm:flex-row">
        <h1 className="flex items-center gap-3 text-xl font-semibold">
          ...
          <code className="font-mono text-lg">{`<CldUploadButton />`}</code>
        </h1>
        <p>
          <a
            className="flex items-center justify-center gap-2 text-sm"
            href="https://github.com/cloudinary-community/cloudinary-examples/tree/main/examples/nextjs-clduploadbutton"
            target="_blank"
          >
            <GitHubIcon />
